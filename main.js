    ...
    this.on('route', function (date) {
      fetch("/data/index.json")
        ...
        .then(function (index) {
          ...
          var elemWidth = 110;
          this$1.root.querySelector('ul').scrollLeft = 110 * 14 - (winWidth / 2) + (elemWidth / 2);
        });
    });
});
