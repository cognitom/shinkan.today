...
var WIN = typeof window === T_UNDEF ? /* istanbul ignore next */ undefined : window;
...
var IE_VERSION = (WIN && WIN.document || /* istanbul ignore next */ {}).documentMode | 0;
...
var IfExpr = {
  ...
  update: function update() {
    ...
    if (this.value) { update$1.call(this.tag, this.expressions); }
  },
  unmount: function unmount() {
    if (this.current) {
...
riot$1.tag2('app-home', '<header> <h1>新刊トゥデイ</h1> </header> <section> <ul> <li each="{days}"> <a href="#{date}"> <span>{jDate}</span> <img each="{books}" title="{title}" riot-src="{cover}"></li> </a> </li> </ul> </section> <footer> <p>Made in OpenSource Cafe</p> <p><a href="https://openbd.jp">Powered by openBD</a></p> <p><a href="https://github.com/cognitom/shinkan.today">GitHub</a></p> </footer>', 'app-home,[data-is="app-home"]{ display: block; } app-home header,[data-is="app-home"] header{ background-color: white; height: 280px; padding-top: 20px; } app-home header > h1,[data-is="app-home"] header > h1{ margin: 0 auto; height: 280px; max-width: 300px; background-image: url(/images/logo.svg); background-position: center; background-size: contain; background-repeat: no-repeat; color: transparent; } app-home footer,[data-is="app-home"] footer{ text-align: center; margin: 15px 0 0; padding: 20px 0; } app-home footer p,[data-is="app-home"] footer p{ margin: 0 0 .5em; } app-home > section,[data-is="app-home"] > section{ margin: 0; padding: 0; height: 340px; overflow-x: scroll; overflow-y: hidden; } app-home > section ul,[data-is="app-home"] > section ul{ margin: 0; padding: 0; list-style: none; height: 100%; width: 3360px; white-space: nowrap; display: -webkit-box; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -ms-flex-direction: row; flex-direction: row; position: relative; } app-home > section ul::before,[data-is="app-home"] > section ul::before{ background-color: white; top: 0; left: 0; width: 100%; height: 30px; content: "*"; color: transparent; position: absolute; } app-home > section li,[data-is="app-home"] > section li{ margin: 0; padding: 80px 10px 0; width: 100px; height: 260px; text-align: center; overflow: hidden; position: relative; display: block; } app-home > section a,[data-is="app-home"] > section a{ display: block; } app-home > section span,[data-is="app-home"] > section span{ position: absolute; top: 0; left: 30px; width: 60px; height: 60px; border-radius: 30px; color: #2c3644; background-color: #D9D3C7; font-size: 85%; line-height: 60px; white-space: nowrap; } app-home > section img,[data-is="app-home"] > section img{ width: 100px; display: block; margin-bottom: 10px; }', '', function(opts) {
    var this$1 = this;
    ...
    this.on('route', function (date) {
      window.fetch('/data/index.json')
        ...
        .then(function (index) {
          ...
          var elemWidth = 120;
          this$1.root.querySelector('section').scrollLeft = elemWidth * 14 - (winWidth / 2) + (elemWidth / 2);
        });
    });
});
