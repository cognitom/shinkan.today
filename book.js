...
function isbn13to10 (isbn13) {
  var digits = isbn13.toString().substr(3, 9).split('');
  var sum = digits
    .map(function (digit) { return digit - 0; })
    .reduce(function (acc, cur, index) { return acc + cur * (10 - index); }, 0);
  var tmp = 11 - (sum % 11);
  var checkDigit = tmp === 10 ? 'x' : tmp === 11 ? '0' : tmp.toString();
  return digits.concat(checkDigit).join('')
}

riot$1.tag2('goto-amazon', '<a href="{url}">amazon.co.jp</a>', 'goto-amazon,[data-is="goto-amazon"]{ display: block; background: rgba(255, 255, 255, .1); border: 1px solid rgba(255, 255, 255, .3); border-radius: 3px; color: rgba(255, 255, 255, .8); text-align: center; padding: .5em; margin: 0 auto; width: 80%; max-width: 500px; } goto-amazon a,[data-is="goto-amazon"] a{ display: block; }', '', function(opts) {

    var isbn10 = isbn13to10(opts.isbn);
    this.url = 'https:/' + '/www.amazon.co.jp/dp/' + isbn10;
});

riot$1.tag2('goto-booklog', '<a href="{url}">ブクログ</a>', 'goto-booklog,[data-is="goto-booklog"]{ display: block; background: rgba(255, 255, 255, .1); border: 1px solid rgba(255, 255, 255, .3); border-radius: 3px; color: rgba(255, 255, 255, .8); text-align: center; padding: .5em; margin: 0 auto; width: 80%; max-width: 500px; } goto-booklog a,[data-is="goto-booklog"] a{ display: block; }', '', function(opts) {

    var isbn10 = isbn13to10(opts.isbn);
    this.url = 'http:/' + '/booklog.jp/item/1/' + isbn10;
});

riot$1.tag2('goto-calil', '<a href="{url}">カーリル</a>', 'goto-calil,[data-is="goto-calil"]{ display: block; background: rgba(255, 255, 255, .1); border: 1px solid rgba(255, 255, 255, .3); border-radius: 3px; color: rgba(255, 255, 255, .8); text-align: center; padding: .5em; margin: 0 auto; width: 80%; max-width: 500px; } goto-calil a,[data-is="goto-calil"] a{ display: block; }', '', function(opts) {

    var isbn10 = isbn13to10(opts.isbn);
    this.url = 'https:/' + '/calil.jp/book/' + isbn10;
});

riot$1.tag2('goto-kinokuniya', '<a href="{url}">紀伊国屋書店</a>', 'goto-kinokuniya,[data-is="goto-kinokuniya"]{ display: block; background: rgba(255, 255, 255, .1); border: 1px solid rgba(255, 255, 255, .3); border-radius: 3px; color: rgba(255, 255, 255, .8); text-align: center; padding: .5em; margin: 0 auto; width: 80%; max-width: 500px; } goto-kinokuniya a,[data-is="goto-kinokuniya"] a{ display: block; }', '', function(opts) {
